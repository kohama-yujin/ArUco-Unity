...
public class UdpReceiver : MonoBehaviour
{
    ...
    // 最新のカメラ回転
    private Quaternion latestCameraRot = Quaternion.identity;
    ...
    void Update()
    {
        ...
        lock(lockObj)
        {
            targetCamera.fieldOfView = latestVerticalFov;
        }

        // カメラ位置を更新
        lock(lockObj)
        {
            targetCamera.transform.localRotation = latestCameraRot;
            targetCamera.transform.localPosition = latestCameraPos;
        }
